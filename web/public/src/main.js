...
export const VIEWS = {
  ...
  corner:   { pos: [21.5, 2.9,  2.2], look: [11.0, 4.2, 12.5], fov: 66 },
  ...
  // Down the street the other way, so the backdrop and the far end are in frame.
  reverse:  { pos: [23.0, 2.9,  3.6], look: [ 2.0, 3.6,  4.4], fov: 70 },
};
